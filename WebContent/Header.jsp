...
<%
//------------------------------------------------------------------------------------------------
String _TOURNAMENT_NAME = (String) ApplicationContext.getInstance().get(ApplicationContext.TOURNAMENT_NAME);
...
{
%>
<%@page import="ar.com.WareTech.GranDT.middleware.services.ApplicationContext"%>
<table width="100%">
